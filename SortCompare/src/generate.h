...
public:
    ...
    void constant_array(arr_element load_arr[], const int len)
    {
        if (len > protect_size) {
            throw std::invalid_argument("length to initialize is out of range");
        }
    ...
    void increase(arr_element load_arr[], const int len)
    {
        if (len > protect_size) {
            throw std::invalid_argument("length to initialize is out of range");
        }
    ...
    void decreate(arr_element load_arr[], const int len)
    {
        if (len > protect_size) {
            throw std::invalid_argument("length to initialize is out of range");
        }
